...
const Card = ({ img }) => {
  return (
    <div className="w-full sm:w-[80%] lg:w-1/3 h-[350px] relative overflow-hidden group cursor-pointer rounded-md">
      {/*  image  */}
      <img
        src={img}
        alt="animated_card"
      ...
      {/*  text  */}
      <div className="absolute top-[50%] transform group-hover:translate-y-[-50%] transition-all duration-500 hover:bg-black w-full h-full left-0 z-20 right-0 flex items-center justify-center flex-col">
